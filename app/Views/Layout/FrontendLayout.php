...
<head>
    ...
    <link rel="apple-touch-icon" type="image/x-icon" href="<?=  base_url('backend/assets/images/logo.png') ?>">
    <link rel="apple-touch-icon" type="image/x-icon" sizes="72x72" href="<?=  base_url('backend/assets/images/logo.png') ?>">
    <link rel="apple-touch-icon" type="image/x-icon" sizes="114x114" href="<?=  base_url('backend/assets/images/logo.png') ?>">
    <link rel="apple-touch-icon" type="image/x-icon" sizes="144x144" href="<?=  base_url('backend/assets/images/logo.png') ?>">
