...
<head>
    ...
    <meta content="Registration for  Business Investment Forum" name="description" />
                                    ...
                                    <div class="p-5">
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-12 text-center">
                                                <p class="text-muted mb-2"><a href="<?=base_url('forgetPassword')?>" class="text-muted font-weight-medium ml-1">Forgot your password?</a></p>
